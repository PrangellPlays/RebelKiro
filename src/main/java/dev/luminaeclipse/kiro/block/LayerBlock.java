...
public class LayerBlock extends Block {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return switch (((LayerShape)state.get(SHAPE))) {
            case SLAB -> (Boolean)state.get(UP) ? Block.createCuboidShape((double)0.0F, (double)0.0F, (double)0.0F, (double)16.0F, (double)1.0F, (double)16.0F) : Block.createCuboidShape((double)0.0F, (double)-8.0F, (double)0.0F, (double)16.0F, (double)-7.0F, (double)16.0F);
            case STAIR -> VoxelShapes.union((Boolean)state.get(WEST) ? Block.createCuboidShape((double)0.0F, (double)0.0F, (double)0.0F, (double)8.0F, (double)1.0F, (double)8.0F) : Block.createCuboidShape((double)0.0F, (double)-8.0F, (double)0.0F, (double)8.0F, (double)-7.0F, (double)8.0F), new VoxelShape[]{(Boolean)state.get(NORTH) ? Block.createCuboidShape((double)8.0F, (double)0.0F, (double)0.0F, (double)16.0F, (double)1.0F, (double)8.0F) : Block.createCuboidShape((double)8.0F, (double)-8.0F, (double)0.0F, (double)16.0F, (double)-7.0F, (double)8.0F), (Boolean)state.get(EAST) ? Block.createCuboidShape((double)8.0F, (double)0.0F, (double)8.0F, (double)16.0F, (double)1.0F, (double)16.0F) : Block.createCuboidShape((double)8.0F, (double)-8.0F, (double)8.0F, (double)16.0F, (double)-7.0F, (double)16.0F), (Boolean)state.get(SOUTH) ? Block.createCuboidShape((double)0.0F, (double)0.0F, (double)8.0F, (double)8.0F, (double)1.0F, (double)16.0F) : Block.createCuboidShape((double)0.0F, (double)-8.0F, (double)8.0F, (double)8.0F, (double)-7.0F, (double)16.0F)});
            case WALL -> (Boolean)state.get(UP) ? Block.createCuboidShape((double)0.0F, (double)0.0F, (double)0.0F, (double)16.0F, (double)1.0F, (double)16.0F) : Block.createCuboidShape((double)0.0F, (double)-13.0F, (double)0.0F, (double)16.0F, (double)-12.0F, (double)16.0F);
