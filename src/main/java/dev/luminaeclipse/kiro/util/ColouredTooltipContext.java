...
public class ColouredTooltipContext {
    ...
    public ColouredTooltipContext(int width, int height, MatrixStack matrices, DrawContext context, VertexConsumerProvider.Immediate vertexConsumers){
    ...
    public static void render(DrawContext context, int x, int y, int width, int height, int z, ItemStack stack) {
        ...
        int k = width + 3 + 3;
        int l = height + 3 + 3;
        if (stack.getItem() instanceof ColouredTooltipItem colouredTooltipItem){
            int startColor = colouredTooltipItem.startColor();
            int endColor = colouredTooltipItem.endColor();
            int bgColor = colouredTooltipItem.backgroundColor();
